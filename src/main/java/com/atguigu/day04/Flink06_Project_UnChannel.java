...
public class Flink06_Project_UnChannel {
    public static void main(String[] args) throws Exception {
        ...
        //3.直接将数据转为tuple2元组
        SingleOutputStreamOperator<Tuple2<String, Integer>> channelWithBehaviorToOneStream = streamSource.map(new MapFunction<MarketingUserBehavior, Tuple2<String, Integer>>() {
            @Override
        ...
        //4.将相同的key聚合
        channelWithBehaviorToOneStream
                .keyBy(0)
                .sum(1)
                .print();
